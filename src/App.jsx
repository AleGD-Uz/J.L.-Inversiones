                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="md:col-span-2 flex flex-col justify-end gap-2 items-end">
                                <div className="flex w-full md:w-auto gap-2">
                                    ...
                                    <GlassButton onClick={() => { setEditingIngredient(null); setShowIngredientForm(true); }} className="flex-1 md:flex-none"><Plus size={16} /> Nuevo</GlassButton>
                                </div>
                                <AdvancedToolbar 
                                ...
                                <GlassCard className="overflow-hidden">
                                    <table className="w-full text-left text-sm min-w-[600px]">
                                        ...
                                        <tbody className="divide-y divide-slate-100">{filterAndSort(ingredients, ['name']).map(ing => {
                                            ...
                                            return (
                                                <tr key={ing.id}><td className="p-4 font-bold">{ing.name}</td><td className="p-4"><PriceDisplay amount={ing.cost || 0} exchangeRate={exchangeRate} size="small" /></td><td className="p-4 text-center"><span className={`font-bold ${ing.stock <= ing.minStock ? 'text-red-500' : ''}`}>{ing.stock} {ing.unit}</span></td><td className="p-4 text-center">
                                    ...
                                    return (
                                        <GlassCard key={ing.id} className="p-5 flex flex-col gap-4">
                                            ...
                                            <div className="flex gap-2 pt-2">
                                                ...
                                                <GlassButton 
                                                    onClick={() => { setEditingIngredient(ing); setShowIngredientForm(true); }}
                                                    variant="secondary" 
